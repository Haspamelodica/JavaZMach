...
import static net.haspamelodica.javazmach.core.header.HeaderField.BoldfaceAvail;
import static net.haspamelodica.javazmach.core.header.HeaderField.ColorsAvail;
import static net.haspamelodica.javazmach.core.header.HeaderField.ColorsReq;
...
import static net.haspamelodica.javazmach.core.header.HeaderField.FixedSpaceAvail;
import static net.haspamelodica.javazmach.core.header.HeaderField.Flags1;
import static net.haspamelodica.javazmach.core.header.HeaderField.Flags2;
...
import static net.haspamelodica.javazmach.core.header.HeaderField.ForceFixedPitchPrint;
import static net.haspamelodica.javazmach.core.header.HeaderField.GlobalVarTableLoc;
import static net.haspamelodica.javazmach.core.header.HeaderField.HeaderExtTableLoc;
...
import static net.haspamelodica.javazmach.core.header.HeaderField.InterpreterNum;
import static net.haspamelodica.javazmach.core.header.HeaderField.InterpreterVer;
import static net.haspamelodica.javazmach.core.header.HeaderField.ItalicAvail;
import static net.haspamelodica.javazmach.core.header.HeaderField.MainLoc;
import static net.haspamelodica.javazmach.core.header.HeaderField.MenusReq;
import static net.haspamelodica.javazmach.core.header.HeaderField.MouseReq;
import static net.haspamelodica.javazmach.core.header.HeaderField.ObjTableLoc;
import static net.haspamelodica.javazmach.core.header.HeaderField.OutSt3WidthPixels;
import static net.haspamelodica.javazmach.core.header.HeaderField.PicDisplayingAvail;
import static net.haspamelodica.javazmach.core.header.HeaderField.PicsReq;
import static net.haspamelodica.javazmach.core.header.HeaderField.ReleaseNumber;
...
import static net.haspamelodica.javazmach.core.header.HeaderField.ScrRedrawControl;
import static net.haspamelodica.javazmach.core.header.HeaderField.ScrSplitAvail;
...
import static net.haspamelodica.javazmach.core.header.HeaderField.SoundFXAvail;
import static net.haspamelodica.javazmach.core.header.HeaderField.SoundFXReq;
import static net.haspamelodica.javazmach.core.header.HeaderField.StandardRev;
import static net.haspamelodica.javazmach.core.header.HeaderField.StatLineNotAvail;
...
import static net.haspamelodica.javazmach.core.header.HeaderField.StoryfileSplit;
import static net.haspamelodica.javazmach.core.header.HeaderField.StringsOff;
import static net.haspamelodica.javazmach.core.header.HeaderField.Tandy;
import static net.haspamelodica.javazmach.core.header.HeaderField.TermCharsTableLoc;
import static net.haspamelodica.javazmach.core.header.HeaderField.TimedKeyInputAvail;
import static net.haspamelodica.javazmach.core.header.HeaderField.Transcipting;
import static net.haspamelodica.javazmach.core.header.HeaderField.UndoReq;
import static net.haspamelodica.javazmach.core.header.HeaderField.VarPitchFontDefault;
