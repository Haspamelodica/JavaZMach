...
import net.haspamelodica.javazmach.assembler.core.assembledentries.AssembledEntry;
...
import net.haspamelodica.javazmach.assembler.core.valuereferences.EntryEndLocation;
import net.haspamelodica.javazmach.assembler.core.valuereferences.EntryStartLocation;
		...
		Map<Section, BigIntegerSummary> sectionTypeSummaries = entries
				...
				.map(e -> new SectionTypeHint(locationManager.resolveAbsoluteOrNullIntegral(new EntryStartLocation(e)),
						locationManager.resolveAbsoluteOrNullIntegral(new EntryEndLocation(e)), switch(e)
						{
							...
							// the entries below aren't associated with any section type by themselves
							...
							case AssembledAlignment entry -> null;
						}))
