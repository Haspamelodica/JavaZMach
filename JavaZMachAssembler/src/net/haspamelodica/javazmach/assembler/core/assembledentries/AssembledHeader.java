...
import static net.haspamelodica.javazmach.assembler.core.valuereferences.SectionLikeLocation.FILE_CHECKSUM;
import static net.haspamelodica.javazmach.assembler.core.valuereferences.SectionLikeLocation.FILE_END;
import static net.haspamelodica.javazmach.assembler.core.valuereferences.SectionLikeLocation.HIGH_MEM_BASE;
import static net.haspamelodica.javazmach.assembler.core.valuereferences.SectionLikeLocation.STATIC_MEM_BASE;
import static net.haspamelodica.javazmach.assembler.core.valuereferences.SpecialDataStructureLocation.DICTIONARY;
import static net.haspamelodica.javazmach.assembler.core.valuereferences.SpecialDataStructureLocation.GLOBAL_VAR_TABLE;
import static net.haspamelodica.javazmach.assembler.core.valuereferences.SpecialDataStructureLocation.OBJ_TABLE;
...
import net.haspamelodica.javazmach.assembler.core.NoRangeCheckMemory;
import net.haspamelodica.javazmach.assembler.core.assembledentries.header.AssembledIntegralBitfieldHeaderField;
import net.haspamelodica.javazmach.assembler.core.assembledentries.header.AssembledIntegralHeaderField;
import net.haspamelodica.javazmach.assembler.core.assembledentries.header.AssembledIntegralRegularHeaderField;
